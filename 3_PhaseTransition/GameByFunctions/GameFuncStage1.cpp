...
static SDL_FRect g_source_rectangle_stage1; // the rectangle for source image
static SDL_FRect g_destination_rectangle_stage1; // for destination
...
void Render_Stage1()
{
	...
	SDL_RenderTexture(g_renderer, g_texture_stage1, &g_source_rectangle_stage1, &g_destination_rectangle_stage1);
